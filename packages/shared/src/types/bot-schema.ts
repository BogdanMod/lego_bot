 ...
 *       "buttons": [
 *         { "type": "navigation", "text": "О нас", "nextState": "about" },
 *         { "type": "navigation", "text": "Контакты", "nextState": "contacts" }
 *       ]
 *     },
 *     "collect_contact": {
 *       "message": "Нам нужен ваш телефон",
 *       "buttons": [
 *         { "type": "request_contact", "text": "📱 Поделиться номером", "nextState": "contacts" }
 *       ]
 *     },
 *     "about": {
